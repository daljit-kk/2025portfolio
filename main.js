...
document.addEventListener("DOMContentLoaded", () => {
    // List of words for dynamic-text-play
    const words = ["Experimentation.", "Play.", "Having Fun.", "Letting Loose."];
    let currentIndex = 0;

    // Get the element for dynamic-text-play
    const dynamicText = document.getElementById("dynamic-text-play");
...
document.addEventListener("DOMContentLoaded", () => {
    // List of words for dynamic-text-two
    const words = ["Creativity", "Curiousity", "Passion"];
    let currentIndex = 0;

    // Get the element for dynamic-text-two
    const dynamicText = document.getElementById("dynamic-text-two");
...
document.addEventListener("DOMContentLoaded", () => {
    // List of words for dynamic-text-footer
    const words = ["Say Hi", "Drop a Line", "Let's Connect"];
    let currentIndex = 0;

    // Get the element for dynamic-text-footer
    const dynamicText = document.getElementById("dynamic-text-footer");
